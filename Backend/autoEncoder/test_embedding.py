...
if __name__ == "__main__":
    ...
    dataset = 'C:/Users/Windows/Desktop/cropped_images'
    images = load_images(dataset)   

    autoencoder = load_model("C:/Users/Windows/Desktop/UGProject/Backend/autoEncoder/checkpoints/autoencoder_basic.keras")
    encoder = Model(inputs=autoencoder.input, outputs=autoencoder.get_layer('encoded').output)
    embeddingFile = 'C:/Users/Windows/Desktop/UGProject/Backend/autoEncoder/AE_colon.npy'
